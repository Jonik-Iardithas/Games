...
$UninstallText = "Dieser Uninstaller entfernt das Programm Games und seine Komponenten."
$SuccessText = "Deinstallation erfolgreich abgeschlossen!"
$Global:Settings = "$env:LOCALAPPDATA\PowerShellTools\Games"
$Global:Path = (Split-Path -Path $PSCommandPath -Parent) + "\Games.ps1"
$Global:Desktop = "$env:USERPROFILE\Desktop\Games.lnk"
$Global:StartMenu = "$env:APPDATA\Microsoft\Windows\Start Menu\Programs\PowerShellTools\Games"
...
$Form.Text = "Uninstaller für Games"
